package com.zhaohg.request.interceptor;


import com.zhaohg.request.req.BaseRequest;
import com.zhaohg.request.util.StringUtil;
...
public class ReqNoDrcAspect {
    ...
    public void init() throws Exception {
        logger.info("request double init......");
    }

    @Pointcut("@annotation(com.zhaohg.request.anotation.CheckReqNo)")
