...
public class TestMergeSchedulerExternal extends LuceneTestCase {
    ...
    private class MyMergeScheduler extends ConcurrentMergeScheduler {
        ...
        @Override
        protected MergeThread getMergeThread(IndexWriter writer, OneMerge merge) throws IOException {
        ...
        private class MyMergeThread extends MergeThread {
            public MyMergeThread(IndexWriter writer, OneMerge merge) {
                super(writer, merge);
