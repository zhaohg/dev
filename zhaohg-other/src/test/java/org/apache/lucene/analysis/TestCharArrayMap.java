...
public class TestCharArrayMap extends LuceneTestCase {
    ...
    public void testModifyOnUnmodifiable() {
        ...
        assertFalse("NoteTest String already exists in map", map.containsKey(NOT_IN_MAP));
        assertNull("NoteTest String already exists in map", map.get(NOT_IN_MAP));
        ...
        try {
            ...
            // expected
            assertFalse("NoteTest String has been added to unmodifiable map", map.containsKey(NOT_IN_MAP));
            assertNull("NoteTest String has been added to unmodifiable map", map.get(NOT_IN_MAP));
