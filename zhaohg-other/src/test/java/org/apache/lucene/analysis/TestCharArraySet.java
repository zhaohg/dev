...
public class TestCharArraySet extends LuceneTestCase {
    ...
    public void testModifyOnUnmodifiable() {
        ...
        assertFalse("NoteTest String already exists in set", set.contains(NOT_IN_SET));
        ...
        try {
            ...
            // expected
            assertFalse("NoteTest String has been added to unmodifiable set", set.contains(NOT_IN_SET));
    ...
    /**
     * NoteTest the static #copy() function with a CharArraySet as a source
     */
    ...
    /**
     * NoteTest the static #copy() function with a JDK {@link Set} as a source
     */
