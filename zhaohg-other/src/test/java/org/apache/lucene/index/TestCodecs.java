...
ate void write(SegmentInfo si, final FieldInfos fieldInfos, final Directory dir, final FieldData[] fields) throws Throwable {
...
ic void testDocsOnlyFreq() throws Exception {
...
ate static class DataFields extends Fields {
...
ate static class DataTerms extends Terms {
    ...
    priv
ate static class DataTermsEnum extends TermsEnum {
        final   FieldData fieldData;
        private int       upto = -1;
    ...
    priv
ate static class DataPostingsEnum extends PostingsEnum {
    ...
    private class Verify extends Thread {
        ...
        public void _run() throws Throwable {
            ...
            for (int iter = 0; iter < NUM_TEST_ITER; iter++) {
                ...
                int upto = 0;
                // NoteTest straight enum of the terms:
                while (true) {
                    final BytesRef term = termsEnum.next();
                    if (term == null) {
                        break;
                ...
                // NoteTest seek to non-existent terms:
                if (VERBOSE) {
