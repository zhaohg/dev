...
public class TestDirectoryReaderReopen extends LuceneTestCase {
  ...
  abst  priv  private Object createReaderMutex = new Object();
    ...
    abst  stat  public void testReopenOnCommit() throws Throwable {
        Directory dir = newDirectory();
...
ract static class ReaderThreadTask {
...
ate static class ReaderThread extends Thread {
        ReaderThreadTask task;
        Throwable        error;
...
ract static class TestReopen {
    ...
    // L
ic class KeepAllCommits extends IndexDeletionPolicy {
        @Override
  ...
  UCENE-5931: we make a "best effort" to catch this abuse and throw a clear(er)
