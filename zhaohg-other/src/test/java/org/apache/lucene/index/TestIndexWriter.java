...
public class TestIndexWriter extends LuceneTestCase {
    ...
    /**
     * NoteTest that no NullPointerException will be raised,
    ...
    privThreadInterruptDeadlock() throws Exception {
    ...
    static final class Strlass Ssure we skip wicked long terms.
     */
    ...
    private static class RUCENE-2812/LUCENE-4738:
  ...
  lic void testNRTAfterSetUserDataWithoutCommit() throws Exception {
        Directory dir = newDirectory();
        IndexWriterConfig iwc = new IndexWriterConfig(new MockAnalyzer(random()));
        IndexWriter w = new IndexWriter(dir, iwc);
        w.commit();
    ...
    // LUCENE-6505
    pub
ingSplitAnalyzer extends Analyzer {
        @Override
    ...
    private static clic void testNRTAfterSetUserDataWithCommit() throws Exception {
        Directory dir = newDirectory();
        IndexWriterConfig iwc = new IndexWriterConfig(new MockAnalyzer(random()));
        IndexWriter w = new IndexWriter(dir, iwc);
        w.commit();
    ...
    // LUCENE-6523
    pub
tringSplitTokenizer extends Tokenizer {
        private       StriTermAttribute termAtt = addAttribute(CharTermAttribute.class);
        
        public S ng[]          tokens;
        private       intr              upto;
        private final ChatringSplitTokenizer() {
            super();
        }
    ...
    /**
     * Make lic void testCommitImmediatelyAfterNRTReopen() throws Exception {
        Directory dir = newDirectory();
        IndexWriterConfig iwc = new IndexWriterConfig(new MockAnalyzer(random()));
        IndexWriter w = new IndexWriter(dir, iwc);
        w.commit();
    ...
    public void testWithPe
andomFailingIterable<T> implements Iterable<T> {
    ...
    // LUCENE-2727/LndingDeletions() throws Exception {
    ...
    public void testLeftov
ate class IndexerThreadInterrupt extends Thread {
final   final    Random                random;
        final    Directory             adder;
       ByteArrayOutputStream bytesLog       = new ByteArrayOutputStream();
    ...
    public void testerTempFiles() throws Exception {
        Directory dir = newDirectory();
        IndexWriterConfig iwc = new IndexWriterConfig(new MockAnalyzer(random()));
        IndexWriter w = new IndexWriter(dir, iwc);
        w.close();
