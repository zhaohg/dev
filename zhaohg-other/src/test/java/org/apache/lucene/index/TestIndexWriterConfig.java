...
public class TestIndexWriterConfig extends LuceneTestCase {
    ...
    public void testOverrideGetters() throws Exception {
        // NoteTest that IndexWriterConfig overrides all getters, so that javadocs
