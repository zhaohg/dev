...
e clasLocal<Thread> doFail = new ThreadLocal<>();
    
    private clas void testRandomExceptions() throws Throwable {
        if (VERBOSE) {
    ...
    // LUCENE-11e static String CRASH_FAIL_MESSAGE = "I'm experiencing problems";
    
    private clas void testExceptionDocumentsWriterInit() throws IOException {
        Directory dir = newDirectory();
    ...
    private state sure an aborting exception closes the writer:
    ...
    // Throws IOO: these are also in TestIndexWriter... add a simple doc-writing method
    ...
    private stat void testExceptionsDuringCommit() throws Throwable {
    ...
    private stat void testAddDocsNonAbortingException() throws Exception {
        final Directory dir = newDirectory();
    ...
    privatest a null bytesref value doesn't abort the entire segment
     */
...
98
    ...
    public void
ic final class TestPoint3 implements RandomIndexWriter.TestPoint {
        boolean doFail;
        boolean failed;
    ...
    /testCrazyPositionIncrementGap() throws Exception {
        Directory dir = newDirectory();
    ...
    static class
ic class FailOnlyOnFlush extends MockDirectoryWrapper.Failure {
    ...
    // mak void
Exception during MockDirectoryWrapper.sync
    ...
    // TODtestExceptionOnCtor() throws Exception {
    ...
    public void
ic class FailOnlyInCommit extends MockDirectoryWrapper.Failure {
        
        boolean static final String  PREPARE_STAGE = "prepareCommit";
        private static final String  FINISH_STAGE  = "finishCommit";
        private final        boolean dontFailDuringGlobalFieldMap;
        private final        String  stage;
        
       failOnCommit, failOnDeleteFile;
        private  public FailOnlyInCommit(boolean dontFailDuringGlobalFieldMap, String stage) {
    ...
    publictestBoostOmitNorms() throws Exception {
        Directory dir = newDirectory();
...
47
    ...
    // LUCE-4870 TooManyOpenFiles errors are thrown as
    ...
    // Make sure
ic class FailOnTermVectors extends MockDirectoryWrapper.Failure {
    ...
    public if we hit a transient IOException (e.g., disk
    ...
    // kind of s
 UOEDirectory extends RAMDirectory {
        boolean doFail = false;
    ...
    publiclow, but omits positions, so just CPU
    @Nightly
    ...
    public void
s IndexerThread extends Thread {
        
        IndexWri Random    r = new Random(random().nextLong());
        volatil  final   ter writer;
    ...
    ThreadtestExceptionDuringRollback() throws Exception {
    ...
    public void
s TestPoint1 implements RandomIndexWriter.TestPoint {
    ...
    publictestRandomExceptionDuringRollback() throws Exception {
    ...
    public void
s CrashingFilter extends TokenFilter {
        String fieldName;
        int    count;
    ...
    publictestMergeExceptionIsTragic() throws Exception {
        MockDirectoryWrapper dir = newMockDirectory();
