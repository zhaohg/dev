...
public class TestTermVectorsReader extends LuceneTestCase {
  ...
  priv  public void test() throws IOException {
    ...
    }ic void testIllegalVectorPositionsWithoutIndexed() throws Exception {
        Directory dir = newDirectory();
        MockAnalyzer a = new MockAnalyzer(random());
        a.setEnableChecks(false);
        RandomIndexWriter w = new RandomIndexWriter(random(), dir, a);
  ...
  ic void testIllegalVectorOffsetsWithoutIndexed() throws Exception {
        Directory dir = newDirectory();
        MockAnalyzer a = new MockAnalyzer(random());
        a.setEnableChecks(false);
        RandomIndexWriter w = new RandomIndexWriter(random(), dir, a);
    ...
    publ
ate class MyAnalyzer extends Analyzer {
        @Override
  ...
  ic void testIllegalVectorPayloadsWithoutIndexed() throws Exception {
        Directory dir = newDirectory();
        MockAnalyzer a = new MockAnalyzer(random());
        a.setEnableChecks(false);
        RandomIndexWriter w = new RandomIndexWriter(random(), dir, a);
