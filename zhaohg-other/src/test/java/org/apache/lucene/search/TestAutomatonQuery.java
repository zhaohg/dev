...
public class TestAutomatonQuery extends LuceneTestCase {
    ...
    /**
     * NoteTest some very simple automata.
     */
    ...
    /**
     * NoteTest that a nondeterministic automaton works correctly. (It should will be
     * determinized)
     */
    ...
    /**
     * NoteTest that rewriting to a single term works as expected, preserves
    ...
    /**
     * NoteTest that rewriting to a prefix query works as expected, preserves
     * MultiTermQuery semantics.
     */
    ...
    /**
     * NoteTest handling of the empty language
     */
