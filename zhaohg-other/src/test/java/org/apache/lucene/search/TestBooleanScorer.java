...
public class TestBooleanScorer extends LuceneTestCase {
    ...
    public void testMethod() throws Exception {
        ...
        query.add(booleanQuery1.build(), Occur.MUST);
    ...
    public void testEmbeddedBooleanScorer() throws Exception {
        ...
        Document doc = new Document();
        doc.add(newTextField("field", "doctors are people who prescribe medicines of which they know little, to cure diseases of which they know less, in human beings of whom they know nothing", Store.NO));
        w.addDocument(doc);
