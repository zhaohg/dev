...
public class TestIndexSearcher extends LuceneTestCase {
    ...
    public void setUp() throws Exception {
        ...
        for (int i = 0; i < 100; i++) {
            ...
            doc.add(newStringField("field", Integer.toString(i), Store.NO));
            doc.add(newStringField("field2", Boolean.toString(i % 2 == 0), Store.NO));
    ...
    public void testCount() throws IOException {
        ...
        for (boolean delete : new boolean[]{false, true}) {
            ...
            // NoteTest multiple queries, some of them are optimized by IndexSearcher.count()
