...
public class TestTimeLimitingCollector extends LuceneTestCase {
    ...
    /**
     * NoteTest that timeout is obtained, and soon enough!
     */
    ...
    /**
     * NoteTest timeout behavior when resolution is modified.
     */
    ...
    /**
     * NoteTest correctness with multiple searching threads.
     */
