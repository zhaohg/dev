...
public class TestAttributeSource extends LuceneTestCase {
    ...
    public void testRemoveAllAttributes() {
        ...
        // Add attributes with the default factory1, then try to remove all of them
        ...
        // Add attributes with the packed implementations factory1, then try to remove all of them
