...
/**
 * Created by zhaohg on 2018-04-08.
 */
public class ElasticSearchTest {
    ...
    public void testInfo() {
        ...
        for (DiscoveryNode node : nodes) {
            System.out.println("集群节点：" + node.getHostName() + ":" + node.getHostAddress());
        }
    }
...
//        String line = null;
//        try {
//            File file = new File("/Users/zhaohg/importBulk.txt");
...
//        try {
//            File file = new File("/Users/zhaohg/exportBulk.txt");
...
//    }
    ...
    public void autoBulkProcessor() throws Exception {
        ...
        //提交单个
        //String json = "{\"id\":\"66\",\"author\":\"ckse\",\"title\":\"windows编程\",\"content\":\"windows 32 API编程\",\"price\":\"99\",\"view\":\"222\",\"date\":\"2018-08-01 17:21:18\"}";
        //bulkProcessor.add(new IndexRequest("设置的index name", "设置的type name","要插入的文档的ID").source(json));//添加文档，以便自动提交
        for (int i = 0; i < 80080; i++) {
            //业务对象
            String json = "{\"id\":\"" + i + "\",\"author\":\"ckse\",\"title\":\"windows编程\",\"content\":\"windows 32 API编程\",\"price\":\"99\",\"view\":\"222\",\"date\":\"2018-08-01 17:21:18\"}";
    ...
    public void multipleBulkProcessor() throws Exception {
        ...
        for (int i = 500; i < 1000; i++) {
            //业务对象
            String jsons = "{\"id\":\"" + i + "\",\"author\":\"ckse\",\"title\":\"windows编程\",\"content\":\"windows 32 API编程\",\"price\":\"99\",\"view\":\"222\",\"date\":\"2018-08-01 17:21:18\"}";
...
//      AggregationBuilders.reverseNested("res_negsted").path("kps ");
    ...
    public void index() throws Exception {
        ...
        IndexResponse indexResponse = client.prepareIndex("demo3", "info", "100").setSource(infoMap)
                .execute().actionGet();
    ...
    public void updateData() {
        Map<String, Object> infoMap = new HashMap<>();
        infoMap.put("name", "11");
        infoMap.put("title", "22");
        infoMap.put("createTime", new Date());
        infoMap.put("count", 1022);
        UpdateResponse updateResponse = client.prepareUpdate("demo3", "info", "100")
                .setDoc(infoMap).get();
