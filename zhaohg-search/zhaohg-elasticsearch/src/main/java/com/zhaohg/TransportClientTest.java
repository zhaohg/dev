...
public class TransportClientTest {
    ...
    public void CreateIndexAndMapping() throws Exception {
        ...
        XContentBuilder mapping = XContentFactory.jsonBuilder()
                ...
                .startObject("date").field("type", "date").field("format", "yyyy-MM-dd HH:mm:ss") //设置Date的格式
                .endObject()
                .endObject()
                .endObject();
    ...
    public void addIndexAndDocument() throws Exception {
        ...
        IndexResponse response = client.prepareIndex(article, content)
                .setSource(XContentFactory.jsonBuilder().startObject()
                        ...
                        .endObject())/*.setIndex(article).setType(content).setId("447")*/
                .get();
    ...
    public void ImportBulk() {
        ...
        String line = null;
        try {
            File file = new File("/Users/zhaohg/bulk.txt");
