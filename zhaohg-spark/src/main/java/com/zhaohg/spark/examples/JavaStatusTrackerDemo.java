...
public final class JavaStatusTrackerDemo {
    ...
    public static void main(String[] args) throws Exception {
        ...
        while (!jobFuture.isDone()) {
            ...
            SparkJobInfo job = jsc.statusTracker().getJobInfo(currentJobId);
            SparkStageInfo stage = jsc.statusTracker().getStageInfo(job.stageIds()[0]);
            System.out.println(stage.numTasks() + " tasks total: " + stage.numActiveTasks() +
                    " active, " + stage.numCompletedTasks() + " complete");
        }
