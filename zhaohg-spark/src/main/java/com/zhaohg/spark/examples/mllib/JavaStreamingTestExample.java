...
/**
 * Perform streaming testing using Welch's 2-sample t-demo3 on a stream of data, where the data
 ...
 * <p>
 * As you add text files to `dataDir` the significance demo3 wil continually update every
 * `batchDuration` seconds until the demo3 becomes significant (p-value < 0.05) or the number of
...
public class JavaStreamingTestExample {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // Stop processing if demo3 becomes significant or we time out
